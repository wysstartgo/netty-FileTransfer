...
public final class CountingChannelPoolHandler implements ChannelPoolHandler {
    ...
    public void channelCreated(Channel ch) {
        System.out.println("===================channelCreated:" + channelCount.incrementAndGet());
    }

    @Override
    public void channelReleased(Channel ch) {
        System.out.println("===================channelReleased:" + releasedCount.incrementAndGet());
    }

    @Override
    public void channelAcquired(Channel ch) {
        System.out.println("===================channelAcquired:" + acquiredCount.incrementAndGet());
    }
